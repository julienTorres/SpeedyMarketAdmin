...
public class LoginService {
    ...
    public void authenticate() {
        System.out.println("*********************** le "+new SimpleDateFormat("dd.MM.yyy").format(new Date())+" a "
                +new SimpleDateFormat("HH:mm:ss").format(new Date())+" : Tentative d'authentification d'un admin ");
